...
{
	public StaticAclAuthenticationService(ILoggerFactory loggerFactory, StaticAclOptions options) : base(
		loggerFactory,
		options
	) { }
	...
	private AclAuthenticationResult TryAuthenticateWithFallbackPolicy()
	{
